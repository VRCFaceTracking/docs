...
* [Blended Shapes](#ue-blended-shapes), which are more simplified shapes that blends together many Base Shapes.
...
officially supported simplified shapes for avatars.
