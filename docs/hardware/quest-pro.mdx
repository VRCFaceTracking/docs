...
### SteamVR Link
<details>
<summary>SteamVR Link Setup</summary>
  This tutorial assumes you are already connected with your computer, and you can see the SteamVR Dashboard.

  - [**MAKE SURE YOUR HEADSET HAS EYE AND FACE TRACKING ENABLED**](#enabling-eye-and-face-tracking-on-the-headset)
  - Open the SteamVR Dashboard and navigate to the VR Settings tab.
  <div style={{
    width: '75%',
    height: 'auto',
    margin: 'auto',
  ...
  - Select the Steam Link tab and adjust the following settings
    * Enable OSC
    * Enable sharing Face and Eye Tracking to other apps via OSC
    * Change the OSC Output Port to 9015
  <div style={{
    width: '75%',
    height: 'auto',
    margin: 'auto',
    ...
    <img src={require("./img/quest/SVRL-OSC.jpg").default} alt="Adjusting OSC settings for Face Tracking" />
  </div>

  - Proceed to [Modules](#modules) for compatible modules to use with SteamVR Link. 
...
- If you are using SteamVR Link, you will need to use the **[LinkFT Module](https://github.com/ykeara/LinkFT)**.
...
:::note
*The SteamVR Link module is not currently avaliable in the module registry and must be installed manually through the releases page.
:::
