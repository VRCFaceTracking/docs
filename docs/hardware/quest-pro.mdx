...
**STOP**. You've reached the end of the setup instructions for Oculus Link/Airlink. 
...
**STOP**. You've reached the end of the setup instructions for ALXR. 
...
**STOP**. You've reached the end of the setup instructions for ALVR. 
...
0. Install the [1.29.0 Beta version of Virtual Desktop](https://github.com/guygodin/VirtualDesktop/releases/tag/v1.29.0), Quest App as well as PC Streamer. If 1.29.0 has been promoted to live release, or the current live version of Virtual Desktop is greater than 1.29.0, please use the most recent live version of Virtual Desktop.
...
<details>
  ...
  1. Install the beta APK manually. Grab the beta `VirtualDesktop.Android.Quest.apk` (without the 1) from the release page linked above and [install it with SideQuest](#using-sidequest-to-side-load-quest-apps). You will need to uninstall the live version of Virtual Desktop from your Quest first. 

  2. Change to the Beta channel on the Virtual Desktop Meta store page (while logged into your Meta Quest account). You will need to then update the Virtual Desktop app in your headset after this change. 
  <div style={{
    width: '75%',
    height: 'auto',
    margin: 'auto',
  ...
  ~~3. Change to the Beta channel in the Meta Quest phone app (while logged into your Meta Quest account). You will need to then update the Virtual Desktop app in your headset after this change.~~ 
...
**STOP**. You've reached the end of the setup instructions for Virtual Desktop. 
