...
The user is free to choose whatever PCVR method they prefer. 
...
In any case, the user is expected to have the VR PC and the Quest Pro on the same network, with the PC ideally connected to the network via ethernet cable (for wireless PCVR),
or Quest Pro connected to the PC with a high-quality USB 3.0+ cable (for "wired" PCVR).
...
:::warning
**SET THE OPENXR RUNTIME TO OCULUS**.
:::
...
7. Install either the Oculus Quest OpenXR Module or ALXR Local Module from the VRCFaceTracking module registry.

### Virtual Desktop Setup

:::note
This setup assumes that Virtual Desktop has already been purchased on the **Quest Store** in the headset
and set up with the Virtual Desktop Streamer PC-side app.
...
4. Install the [Virtual Desktop VRCFT tracking module](#modules)
...
:::note
Learn how to [sideload applications to you Quest](#using-sidequest-to-side-load-quest-apps)
:::
...
4. Open the `ALXRModuleConfig.json` found in the installed module directory.
   ...
   - [Learn more about the configuration options](https://github.com/korejan/VRCFT-ALXR-Modules#module-settings)
...
4. Install the **ALVR Module** from the VRCFaceTracking module repository.
5. Start the client on the Quest Pro and connect.
...
1. **Quest Pro OpenXR Module**
2. **ALXR Local Module**
   - Learn more about the [ALXR Local/Remote Module configuration options](https://github.com/korejan/VRCFT-ALXR-Modules#module-settings).

If you are using ALXR, you will need to use the **ALXR Remote module**.

If you are using ALVR, you will need to use the **ALVR module**.

If you are using Virtual Desktop, you will need to use the **Virtual Desktop module**.
