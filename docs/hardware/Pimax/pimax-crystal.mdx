...
Download SRanipal_1.3.6.5.zip from the VRCFaceTracking Discord Server in #file-share and extract the contents into the same folder as BrokenEye.exe.
...
### 4) Install the [VRCFT-Tobii-Advanced Module](https://github.com/ghostiam/VRCFT-Tobii-Advanced/releases)
