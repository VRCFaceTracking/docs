...
3. Verify if you have Pico Connect installed on your headset, otherwise you need to get it from the Pico Store.
4. Install [Pico Connect](https://www.picoxr.com/global/software/pico-link) on your computer.
5. After installing Pico Connect on your computer you should update a hidden configuration to change it's facetracking to legacy protocol, 
