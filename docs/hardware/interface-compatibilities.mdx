...
<FilterTable
    ...
    rows={[
        ['Category', 'HMD', 'Accessory', 'HMD', 'Standalone HMD', 'Standalone HMD', 'Accessory', 'HMD', 'Software/Mobile', 'Software', 'Software/DIY Hardware', 'Accessory', 'Accessory', 'HMD', 'Accessory', 'HMD', 'HMD'],
        ['General Face Tracking Capability', 'Eye', 'Lower Face', 'Eye', 'Full', 'Full', 'Eye', 'Eye', 'Full', 'Lower Face', 'Eye', 'Eye', 'Lower Face', 'Eye', 'Full', 'Eye', 'Full'],
        ['Gaze', '✔', '~', '✔', '✔', '✔', '✔', '✔', 'Eye Expression', '~', '✔', '✔', '~', '✔', '✔', '✔', '✔'],
        ['Gaze Convergence', '✔', '~', '✔', '❌', '❌', '❌', '❌', 'N/A', '~', '✔', '✔', '~', '✔', '✔', '~', '❌'],
        ['Eye Openness', 'Granular', '~', 'Granular', 'Granular', 'Granular', '2 Steps', 'Granular', 'Granular', '~', 'Granular', 'Granular', '~', 'Binary', 'Granular', 'Binary', 'Granular'],
        ['Pupil Dilation', '✔', '~', '✔', '❌', '❌', '❌', '❌', '❌', '~', '❌', '❌', '~', '✔', '❌', '✔', '❌'],
        [
        ...
        ['Tongue Expression Support', '~', 'Tongue Out & Directions', '~', 'Tongue Out', 'Tongue Out', '~', '~', 'Tongue Out', 'All Tongue Expressions', '~', '~', 'Tongue Out & Directions', '~', 'Tongue Out & Directions', '~', 'Tongue Out & Directions'],
    ]}
/>
