...
This should open a small info window containing information like the version of SRanipal, as well as the firmware versions of the detected SRanipal compatible hardware.
If you can't seem to right-click the SRanipal tray icon, see the relevant detail in [Troubleshooting](#troubleshooting).
