...
Do not leave VRCFaceTracking unnecessarily running in the background for long periods of time as the size of the log file can easily get into the range of tens to hundreds **gigabytes**
if left unchecked. 
...
- Most users (Vive Pro Eye, Vive Facial Tracker) should use the [v1.3.1.1 installer](#installing-via-v1311-installer) if possible
