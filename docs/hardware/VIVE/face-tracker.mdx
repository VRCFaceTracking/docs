...
Follow the [SRanipal Setup](sranipal.mdx#software) instructions to get this necessary software installed and ready.
...
<details>
    ...
    <div>The adhesive that comes with the Vive Facial Tracker isn’t the best, and can easily fail with a knock to the headset. Here are some alternative mounting solutions</div>
    <br/>
    <div>
