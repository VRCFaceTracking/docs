...
Eye tracking data is accessed through [Vive's SRanipal interface](../../tutorial-modules/sranipal).
...
2. Install the SRanipal runtime software. [See the guide](../../tutorial-modules/sranipal#software)
