...
It also assumes you have a compatible camera device. A standard webcamera will work, but you can also use a phone, etc.
:::

### Installation

Start by mounting your camera underneath your headset. The camera should be facing you, and should be able to see your face clearly. There is no "right" way to do this, feel free to experiment with different placements. Plug your camera into your headset's USB port, if you have one. If you don't, you can use a USB extension cable to plug it into your PC, or use a wireless camera.
...
To uninstall The VRCFT-Babble, navigate to VRCFaceTracking's Module Registry, select the VRCFT-Babble module, and at the bottom of the page click the uninstall button. Additionally, you can navigate to `%\Roaming\VRCFaceTracking\CustomLibs` and delete the file called `VRCFT-Babble.dll`.