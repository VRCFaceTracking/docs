...
Download the latest version of the program from the <CustomLink to="github" append="/tree/v4.0.0"/> repo!

* If you are using a Vive Facial Tracker or other Vive hardware that relies on SRanipal, simply launch the downloaded VRCFaceTracking executable. 
